...
urlpatterns = [
    ...
    path("<int:profile_id>/event/<int:event_id>/edit/", views.event_edit, name="event_edit"),
    path("<int:profile_id>/event/<int:event_id>/delete/", views.event_delete, name="event_delete"),
    path("<int:profile_id>/log/", views.profile_add_log, name="profile_add_log"),
    path("<int:profile_id>/log/<int:log_id>/edit/", views.log_edit, name="log_edit"),
    path("<int:profile_id>/log/<int:log_id>/delete/", views.log_delete, name="log_delete"),
    path("<int:profile_id>/daily/", views.log_daily_routine, name="log_daily_routine"),
    path("<int:profile_id>/analytics/", views.lifetime_analytics, name="lifetime_analytics"),
    path("<int:profile_id>/dossier/", views.profile_dossier, name="profile_dossier"),
    path("<int:profile_id>/dossier/pdf/", views.export_dossier_pdf, name="export_dossier_pdf"),
