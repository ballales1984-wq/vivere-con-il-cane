...
from .views import create_test_account, change_language, emergency_reset_account
...
urlpatterns += [
    ...
    path(
        "__emergency-reset-account__/",
        emergency_reset_account,
        name="emergency_reset_account",
    ),
